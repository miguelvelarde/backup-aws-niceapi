...
API_URL=$(aws cloudformation describe-stacks --stack-name niceapi-sales --region us-east-1 --query "Stacks[0].Outputs[?OutputKey=='ApiURL'].OutputValue" --output text)
